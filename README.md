...
Lokale Speicherung: Speichert die heruntergeladenen Bilder im Ordner C:\Benutzer\<DeinName>\Bilder\BingWallpaper, um eine Sammlung der täglichen Bilder anzulegen.
System-Tray-Integration: Bietet ein Menü für einfache Steuerung:
...
Icon vorbereiten: Stelle sicher, dass sich eine Icon-Datei namens app.ico im selben Verzeichnis wie das Skript befindet.

Anwendung erstellen: Führe den folgenden Befehl im Terminal aus. Er bündelt das Skript, das Icon und alle Abhängigkeiten in einer einzigen .exe-Datei im dist-Ordner.
